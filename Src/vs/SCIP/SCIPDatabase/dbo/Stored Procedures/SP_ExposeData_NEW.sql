...
FROM	(
        ...
        (
        (
			[HANSEN8].[ASSETMANAGEMENT_SEWER].COMPSMN A 
			INNER JOIN 
			[HANSEN8].[ASSETMANAGEMENT_SEWER].COMPSMH B 
			ON	A.UNITID = B.UNITID
		) 
		INNER JOIN 
		[HANSEN8].[ASSETMANAGEMENT_SEWER].COMPSMH C 
        ...
        (
		  ...
		  (
		    ...
		    FROM    [HANSEN8].[WORKMANAGEMENT].[HISTORY] AS A1
		            INNER JOIN 
		            [HANSEN8].[ASSETMANAGEMENT_SEWER].[COMPSMN] AS B1

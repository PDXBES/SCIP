...
namespace UI
{
  public partial class IndividualDriversPage : ChildFormTemplate
  {
    ...
    private void buttonFetchCompkey_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        this.dRIVERS_UPDATETableAdapter.UpdateByCompkey(Int32.Parse(TextEditorCompkey.Text), 
          (int)ultraComboAlternatives.Value);
    ...
    private void ultraComboAlternatives_ValueChanged(object sender, EventArgs e)
    {
      dRIVERTYPESBindingSource.Filter = "alternative_id = " + 
        ((int)ultraComboAlternatives.Value).ToString();
    }
  }
}
